...
export const getAgmEgmNoticesHandler = async (
    ...
    const response = await apiClient.get<AgmEgmNoticeListApiResponse>(
        "/api/v1/agm-egm-notices",
        {
            params,
        }
    )
...
export const getAgmEgmNoticeByIdHandler = async (
    ...
    const response = await apiClient.get<AgmEgmNoticeSingleApiResponse>(
        `/api/v1/agm-egm-notices/${id}`
    )
...
export const createAgmEgmNoticeHandler = async (
    ...
    const response = await apiClient.post<AgmEgmNoticeSingleApiResponse>(
        "/api/v1/agm-egm-notices",
        formData,
        {
            headers: {
...
export const publishAgmEgmNoticeHandler = async (
    ...
    const response = await apiClient.patch<AgmEgmNoticeSingleApiResponse>(
        `/api/v1/agm-egm-notices/${id}/publish`,
        {
...
export const deleteAgmEgmNoticeHandler = async (
    ...
    const response = await apiClient.delete<AgmEgmNoticeDeleteApiResponse>(
        `/api/v1/agm-egm-notices/${id}`,
        {
            data: {
                deleted_by,

...
function Sidebar({
  ...
  const shouldRenderMobile = isHydrated && isMobile
...
function SidebarMenuButton({
  ...
  const Comp = asChild ? Slot.Root : "button"
  const { isMobile, isHydrated, state } = useSidebar()
  const showTooltip = Boolean(tooltip) && isHydrated
